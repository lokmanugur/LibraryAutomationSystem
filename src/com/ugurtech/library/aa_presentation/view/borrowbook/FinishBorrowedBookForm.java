 ...
 * @author ugur
 */
public final class FinishBorrowedBookForm extends JInternalFrame {

    private static FinishBorrowedBookForm takenBackForm;
    private final TakenBackFormController takenBackFormController;
    private FinishBorrowedBookForm() {
        initComponents();
        setLocation(getWidth()/2, getHeight()/10);
        takenBackFormController=new TakenBackFormController(this);
    }
    
    public static FinishBorrowedBookForm getInstance(){
        if(takenBackForm==null)
            return takenBackForm= new FinishBorrowedBookForm();
        else
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        BookBorrowedDetailForm.getInstance().getAllBorrowedBooks();
