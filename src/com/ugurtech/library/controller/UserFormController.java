...
public class UserFormController {
    ...
    public boolean checkPassword(){
        ...
        if(check){
            ...
            userForm.getCheckLabel().setText(Internationalization.getInstance().setLanguage("userformcontroller.password.match"));
        }else{
            userForm.getCheckLabel().setForeground(Color.RED);
            userForm.getCheckLabel().setText(Internationalization.getInstance().setLanguage("userformcontroller.password.dont.match"));
        }
        return check;
    }
